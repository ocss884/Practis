...
class TACTiS_PerceiverCopula(nn.Module):
    """
    ...
    def loss(
        ...
        loss = self.decoder.loss(encoded, mask, true_value, query_timesteps)
    ...
    def sample(
        ...
        samples = self.decoder.sample(num_samples, encoded, mask, true_value, query_timesteps)
