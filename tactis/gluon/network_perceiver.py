...
from ..model.tactis_perceiver import TACTiSP


class TACTiSPTrainingNetwork(nn.Module):
    """
    ...
    def __init__(
        ...
        self.model = TACTiSP(num_series, **model_parameters)
...
class TACTiSPPredictionNetwork(nn.Module):
    """
