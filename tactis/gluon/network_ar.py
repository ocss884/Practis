...
from ..model.ar_model import DeepAR

class DeepARTrainingNetwork(nn.Module):
    """
    ...
    def __init__(
        ...
        self.model = DeepAR(num_series, **model_parameters)
...
class DeepARPredictionNetwork(nn.Module):
    """
